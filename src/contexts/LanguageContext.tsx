...
const translations = {
  pt: {
    ...
    'contact.form.segments.commercial': 'Aviação Comercial',
    'contact.form.segments.executive': 'Aviação Executiva',
    'contact.form.segments.taxi': 'Táxi Aéreo',
    'contact.form.segments.cargo': 'Transporte de Carga',
    'contact.form.segments.passengers': 'Transporte de Passageiros',
    'contact.form.segments.other': 'Outro',
    'contact.phone': 'Telefone',
    'contact.email': 'E-mail',
    'contact.address': 'Endereço',
    'contact.hours': 'Horário de Atendimento',
    'contact.phoneDescription': 'Segunda a Sexta, 8h às 18h',
    'contact.emailDescription': 'Resposta em até 24 horas',
    'contact.addressDescription': 'São Paulo/SP - CEP 01310-100',
    'contact.hoursDescription': 'Suporte técnico 24/7',
    'contact.sendMessage': 'Envie sua Mensagem',
    'contact.formDescription': 'Preencha o formulário abaixo e nossa equipe entrará em contato em até 24 horas.',
    'contact.form.subject': 'Assunto *',
    'contact.form.subjectPlaceholder': 'Selecione um assunto',
    'contact.form.subjects.demo': 'Solicitar Demonstração',
    'contact.form.subjects.sales': 'Informações de Vendas',
    'contact.form.subjects.support': 'Suporte Técnico',
    'contact.form.subjects.partnerships': 'Parcerias',
    'contact.form.subjects.other': 'Outros',
    'contact.departments.title': 'Departamentos Especializados',
    'contact.departments.sales.name': 'Vendas',
    'contact.departments.sales.description': 'Informações sobre produtos e demonstrações',
    'contact.departments.support.name': 'Suporte Técnico',
    'contact.departments.support.description': 'Suporte 24/7 para clientes',
    'contact.departments.partnerships.name': 'Parcerias',
    'contact.departments.partnerships.description': 'Oportunidades de negócio e integrações',
    'contact.departments.hr.name': 'Recursos Humanos',
    'contact.departments.hr.description': 'Carreiras e oportunidades de trabalho',
    'contact.location.title': 'Nossa Sede',
    'contact.location.company': 'LATOP - Innovation in Logistics for Transport',
    'contact.location.mapText': 'Mapa Interativo',
    'contact.cta.title': 'Pronto para Começar?',
    'contact.cta.subtitle': 'Agende uma demonstração personalizada e descubra como podemos transformar suas operações',
    'contact.cta.demo': 'Agendar Demonstração',
    'contact.cta.specialist': 'Falar com Especialista',
  ...
  en: {
    ...
    'contact.form.segments.commercial': 'Commercial Aviation',
    'contact.form.segments.executive': 'Executive Aviation',
    'contact.form.segments.taxi': 'Air Taxi',
    'contact.form.segments.cargo': 'Cargo Transport',
    'contact.form.segments.passengers': 'Passenger Transport',
    'contact.form.segments.other': 'Other',
    'contact.phone': 'Phone',
    'contact.email': 'Email',
    'contact.address': 'Address',
    'contact.hours': 'Business Hours',
    'contact.phoneDescription': 'Monday to Friday, 8am to 6pm',
    'contact.emailDescription': 'Response within 24 hours',
    'contact.addressDescription': 'São Paulo/SP - ZIP 01310-100',
    'contact.hoursDescription': '24/7 technical support',
    'contact.sendMessage': 'Send your Message',
    'contact.formDescription': 'Fill out the form below and our team will contact you within 24 hours.',
    'contact.form.subject': 'Subject *',
    'contact.form.subjectPlaceholder': 'Select a subject',
    'contact.form.subjects.demo': 'Request Demo',
    'contact.form.subjects.sales': 'Sales Information',
    'contact.form.subjects.support': 'Technical Support',
    'contact.form.subjects.partnerships': 'Partnerships',
    'contact.form.subjects.other': 'Other',
    'contact.departments.title': 'Specialized Departments',
    'contact.departments.sales.name': 'Sales',
    'contact.departments.sales.description': 'Product information and demonstrations',
    'contact.departments.support.name': 'Technical Support',
    'contact.departments.support.description': '24/7 support for customers',
    'contact.departments.partnerships.name': 'Partnerships',
    'contact.departments.partnerships.description': 'Business opportunities and integrations',
    'contact.departments.hr.name': 'Human Resources',
    'contact.departments.hr.description': 'Careers and job opportunities',
    'contact.location.title': 'Our Headquarters',
    'contact.location.company': 'LATOP - Innovation in Logistics for Transport',
    'contact.location.mapText': 'Interactive Map',
    'contact.cta.title': 'Ready to Get Started?',
    'contact.cta.subtitle': 'Schedule a personalized demo and discover how we can transform your operations',
    'contact.cta.demo': 'Schedule Demo',
    'contact.cta.specialist': 'Talk to Specialist',
